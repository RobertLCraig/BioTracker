...
const form    = ref({ name: '', email: '', password: '', password_confirmation: '', consent: false });
const error   = ref('');
      ...
      <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            ...
            <input v-model="form.name" type="text" placeholder="Jane Smith" required autofocus
          ...
          <label class="flex items-start gap-2.5 cursor-pointer">
            <input v-model="form.consent" type="checkbox" required class="mt-0.5 accent-teal-500 shrink-0" />
            <span class="text-xs text-zinc-400 leading-relaxed">
              I consent to my health data being stored and processed in accordance with the privacy policy.
            </span>
          </label>
